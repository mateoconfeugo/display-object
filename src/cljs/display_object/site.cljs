...
;; home page actions
;;#######################################
(em/deftemplate about :compiled "templates/about.html" [])
...
;;#######################################
(em/deftemplate whats-new :compiled  "templates/whats-new.html" [])
...
;;#######################################
(em/deftemplate gstarted :compiled "templates/getting-started.html" [])
...
;;########################################
(em/deftemplate doc-trans  :compiled "templates/standard-transforms.html" [])
...
;;########################################
(em/deftemplate doc-event :compiled "templates/handling-events.html" [])
...
(em/deftemplate doc-effect :compiled  "templates/effects-timing.html" [])
...
(em/deftemplate doc-template :compiled "templates/templates-snippets.html" [])

(em/deftemplate template-demo :compiled "templates/template-demo.html" [fruit-data]
...
(em/defsnippet snippet2 :compiled "templates/template-demo.html" "tbody > *:first-child"
  [fruit quantity]
  "tr > *:first-child" (ef/content fruit)
  "tr > *:last-child" (ef/content (str quantity)))

(em/deftemplate template-demo2 :compiled "templates/template-demo.html" [fruit-data]
  "#heading1" (ef/content "fruit")
  "thead tr > *:last-child" (ef/content "quantity")
  "tfoot tr > *:last-child" (ef/content (str (apply + (vals fruit-data))))
  "tbody" (ef/content
...
(em/deftemplate doc-from  :compiled "templates/data-extraction.html" [])
...
(em/defaction doc-from-page []
  "#content-pane" (ef/do->  (ef/content (doc-from)) (reset-scroll))
